...
<a href="{{ $tracked_link }}" style="display: inline-block; background-color: #f0644b; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Click Here for free Quote</a>
